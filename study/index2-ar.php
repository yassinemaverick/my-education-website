...
<title>Upskill Platform – تسجيل الدخول</title>
...
<script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=VxMW5vBMbxZjLonxr9EwKe_f-WdkJ0QXf1J-jkp4VERdhXqC5JgBEdHQclv5_2sb8jg6d_a_LIeWY5aWnHN_gI70lOqf7yhg0tXQAUQ7KOjANZ73PWUwUPe7gOMf9HOI0DvrROxkTKv0DmqhrlsATg" charset="UTF-8"></script><link rel="stylesheet" crossorigin="anonymous" href="https://gc.kis.v2.scr.kaspersky-labs.com/E3E8934C-235A-4B0E-825A-35A08381A191/abn/main.css?attr=aHR0cHM6Ly9zcnYxNzg3LWZpbGVzLmhzdGdyLmlvLzQzNDU0ZWI5MDgxMjZhNzMvYXBpL3Jhdy9wdWJsaWNfaHRtbC9zdHVkeS9pbmRleC5odG1sPw"/><style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .input-wrap > svg:first-child { position: absolute; right: 0.9rem; top: 50%; transform: translateY(-50%); color: var(--muted); pointer-events: none; }
  .form-group input {
    width: 100%; padding: 0.85rem 2.6rem 0.85rem 2.8rem; text-align: right; direction: rtl;
...
<div class="left" role="complementary" aria-hidden="false">
  ...
  <div class="left-content">
    <h1>رحلتك التعليمية<br><span>تبدأ من هنا.</span></h1>
    <p>تصفّح لوحة تحكمك المخصصة والواجبات والسبورات التفاعلية وتتبّع تقدمك — كل ذلك في مكان واحد.</p>
    <div class="feature-list">
      <div class="feature-item"><div class="feature-dot"></div><span>مواد الدورة والمصادر</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>الوصول إلى السبورة التفاعلية</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>الواجبات والاختبارات</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>تتبع التقدم في الوقت الفعلي</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>محتوى يديره المعلم</span></div>
    </div>
  </div>

  <div class="left-bottom">
    <a href="https://upskill-edu.com/index-ar.php">→ العودة إلى الموقع الرئيسي</a> &nbsp;·&nbsp; © 2026 Upskill Education
  </div>
</div>
  ...
  <div class="login-box">
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="text" id="username" aria-required="true" name="username" placeholder="أدخل اسم المستخدم" dir="ltr" style="text-align:left" autocomplete="username">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="input-wrap">
        ...
        <input type="password" id="password" aria-required="true" name="password" placeholder="أدخل كلمة المرور" dir="ltr" style="text-align:left" autocomplete="current-password">
    ...
    <div class="back-link">
      <a href="https://upskill-edu.com/index-ar.php">→ العودة إلى <span>upskill-edu.com</span></a>
    </div>
