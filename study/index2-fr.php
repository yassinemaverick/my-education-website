...
<title>Upskill Platform – Connexion</title>
...
<div class="left" role="complementary" aria-hidden="false">
  ...
  <div class="left-content">
    <h1>Votre parcours<br>d'apprentissage<br><span>commence ici.</span></h1>
    <p>Accédez à votre tableau de bord personnalisé, vos devoirs, tableaux blancs et suivi de progression — tout en un seul endroit.</p>
    <div class="feature-list">
      <div class="feature-item"><div class="feature-dot"></div><span>Ressources et supports de cours</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>Accès au tableau blanc interactif</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>Devoirs et quiz</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>Suivi de progression en direct</span></div>
      <div class="feature-item"><div class="feature-dot"></div><span>Contenu géré par le professeur</span></div>
    </div>
  </div>
...
<div class="right" role="main" id="login-section">
  <div class="login-box">
    ...
    <div style="display:flex;gap:0.5rem;justify-content:flex-end;margin-bottom:1.2rem;">
      <a href="index2.php"    style="display:inline-flex;align-items:center;gap:0.3rem;background:transparent;border:1px solid var(--border);color:var(--muted);font-family:var(--font);font-size:0.73rem;font-weight:600;padding:0.3rem 0.75rem;border-radius:100px;text-decoration:none;">🇬🇧 EN</a>
      <a href="index2-fr.php" style="display:inline-flex;align-items:center;gap:0.3rem;background:var(--green-glow);border:1px solid rgba(62,207,120,0.4);color:var(--green);font-family:var(--font);font-size:0.73rem;font-weight:500;padding:0.3rem 0.75rem;border-radius:100px;text-decoration:none;transition:all 0.2s;">🇫🇷 FR</a>
    ...
    <div class="role-tabs" role="tab" role="tablist" aria-label="Sélectionner votre rôle">
      <div class="role-tab active" role="tab" id="tab-student" onclick="setRole('student', this)">👩‍🎓 &nbsp;Étudiant</div>
      <div class="role-tab" role="tab" id="tab-teacher" onclick="setRole('teacher', this)">👨‍🏫 &nbsp;Professeur</div>
    </div>

    <div class="login-title" id="login-title">Bon retour</div>
    <div class="login-subtitle" id="login-subtitle">Connectez-vous à votre compte <span>étudiant</span></div>
    ...
    <div class="form-row">
      ...
      <a href="mailto:Admin@upskill-edu.com?subject=Réinitialisation du mot de passe" class="forgot">Mot de passe oublié ?</a>
    </div>
...
<script>
  ...
  (function() {
    ...
    const msgs = {
      ...
      role:    'Ce compte n\'a pas accès à l\'espace ' + (role === 'teacher' ? 'professeur' : 'étudiant') + '. Sélectionnez le bon rôle.',
    };
  ...
  function setRole(role, tab) {
    ...
    document.getElementById('login-subtitle').innerHTML =
      'Connectez-vous à votre compte <span>' + (role === 'teacher' ? 'professeur' : 'étudiant') + '</span>';
    hideError();
  ...
  function handleSubmit(e) {
    ...
    if (!user || !pass) {
      showError(document.getElementById('username').value.trim() ? '' : '');
