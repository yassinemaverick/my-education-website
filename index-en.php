...
<section id="courses">
  ...
  <div class="courses-grid">
    ...
    <div class="course-card most-popular" data-course="General English" onclick="selectCourse(this)" tabindex="0" role="button" onkeydown="if(event.key==='Enter'||event.key===' '){selectCourse(this);event.preventDefault();}">
