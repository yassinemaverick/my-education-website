...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @keyframes heroPulse {
    ...
    18%  { opacity:0.45; filter:brightness(0.8); }
    36%  { opacity:0.85; filter:brightness(1.1); }
    55%  { opacity:0.38; filter:brightness(0.75); }
    74%  { opacity:0.78; filter:brightness(1.05); }
